...
public class LayoutWrapperTest {
    ...
    @Rule
    public LoggerContextRule init = new LoggerContextRule("LayoutWrapperTestConfig.xml");

    @Test
    public void testLayoutWrapperSync() {
        final Logger logger = init.getLogger("SyncLookupTest");
    ...
    public void testLayoutWrapperAsync() throws InterruptedException {
        final Logger logger = init.getLogger("AsyncLookupTest");
